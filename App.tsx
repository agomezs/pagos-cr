...
function seedIfEmpty() {
  ...
  // Overdue — past due date (will be marked by marcarVencidos)
  ...
  return (
    <View className="px-4 pt-4 pb-2 gap-3">
      ...
      <View className="flex-row gap-3">
        ...
        <StatCard
          label="Vencido"
          cantidad={resumen.cantidadVencidos}
      ...
      <View className="flex-row gap-3">
        <StatCard
          label="Cobrado"
          cantidad={resumen.cantidadPagados}
...
export default function App() {
  ...
  const handleFiltro = (estado: EstadoCobro | null) => {
      ...
      <View className="flex-1 bg-gray-50">
        ...
        >
          ...
          <View className="bg-gray-50">
            <FiltroBar activo={filtroEstado} onChange={handleFiltro} />
          </View>
